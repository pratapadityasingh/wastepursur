...
.border-\[\#070C26\] {
  --tw-border-opacity: 1;
  border-color: rgb(7 12 38 / var(--tw-border-opacity));
}
.border-black {
  --tw-border-opacity: 1;
...
.bg-\[\#060B27\] {
  --tw-bg-opacity: 1;
  background-color: rgb(6 11 39 / var(--tw-bg-opacity));
}
.bg-\[\#060b27\] {
  --tw-bg-opacity: 1;
  background-color: rgb(6 11 39 / var(--tw-bg-opacity));
...
.bg-\[\#cfff13\] {
  --tw-bg-opacity: 1;
  background-color: rgb(207 255 19 / var(--tw-bg-opacity));
}
.bg-blue-500 {
  --tw-bg-opacity: 1;
...
.text-\[\#060B27\] {
  --tw-text-opacity: 1;
  color: rgb(6 11 39 / var(--tw-text-opacity));
}
.text-\[\#cfff13\] {
  --tw-text-opacity: 1;
  color: rgb(207 255 19 / var(--tw-text-opacity));
}
.text-\[\#fff\] {
  --tw-text-opacity: 1;
...
.box_shadow
{
  box-shadow: 0px 0px 10px 0px #cfff13;

}
.backgr
{
  background-image: url(/_next/static/media/111.480f1007.png);
...
.boybg::before{
  content: "";
  background-image: url(/_next/static/media/secondut.61ebe3f5.png);
  position: absolute;
  width: 400px;
  height: 450px;
  background-repeat: no-repeat;
...
.footer_bg {
  ...
  background-image: url(/_next/static/media/footerbg.e4a9ec00.e4a9ec00.png);
  background-repeat: no-repeat;
  background-position: bottom;
  background-size: cover;
}
...
.bg-card
{
  background-image: url(/_next/static/media/fouthbg.0f8b5bd5.0f8b5bd5.png);
  background-position: center;
  background-repeat: no-repeat;
  background-size: cover;
}
